...
function Request() {
  ...
  const fetchRequests = async () => {
    ...
    try {
      const res = await axios.get("https://adoptly-backend.vercel.app/api/getRequest", {
  ...
  const handleAccept = async (req) => {
    try {
      await axios.patch(`https://adoptly-backend.vercel.app/api/request/${req._id}`, {
        status: "accepted",
      });
  ...
  const handleCancel = async (req) => {
    try {
      await axios.delete(`https://adoptly-backend.vercel.app/api/request/${req._id}`);
